 ...
 * @author aluno
 */
public class Tela_Update_Manga extends javax.swing.JFrame {
    Fasciculo_Manga Backup = null;
    String BackupNome = "";
    
    /**
     * Creates new form Tela_Update_Manga
     */
    public Tela_Update_Manga() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            Backup = Controlador.PesquisarMangaUpdate(nome, novo_volume);
            BackupNome = nome;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        if(Backup != null){
            Controlador.DeletarVolumeManga(BackupNome, Backup);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela_Update_Manga.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela_Update_Manga().setVisible(true);
            }
        });
    }
